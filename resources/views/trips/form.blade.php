                    ...
                    <form action="{{ route('trips.update', $trip->id) }}" method="POST" class="px-6 py-5 space-y-5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <div class="fm-field">
                                ...
                                <div class="relative">
                                    <select id="vehicle_id" name="vehicle_id" class="{{ $errors->has('vehicle_id') ? 'is-invalid' : '' }}" style="appearance:none;padding-right:2.5rem;cursor:pointer;" required>
                            ...
                            <div class="fm-field">
                                ...
                                <div class="relative">
                                    <select id="driver_id" name="driver_id" class="{{ $errors->has('driver_id') ? 'is-invalid' : '' }}" style="appearance:none;padding-right:2.5rem;cursor:pointer;" required>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                            <div class="fm-field">
                                ...
                                <input type="datetime-local" id="start_time" name="start_time"
                                       value="{{ old('start_time', $trip->start_time->format('Y-m-d\TH:i')) }}"
                                       class="{{ $errors->has('start_time') ? 'is-invalid' : '' }}" required>
                                @error('start_time')<p class="mt-1 text-xs text-red-500">{{ $message }}</p>@enderror
                            </div>

                            <div class="fm-field">
                                <label for="end_time" class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">
                                    End Time
                                </label>
                            ...
                            <div class="fm-field">
                                ...
                                <input type="number" id="distance" name="distance"
                                       value="{{ old('distance', $trip->distance) }}" step="0.1"
                        ...
                        <div class="fm-field">
                            ...
                            <div class="relative">
                                <select id="status" name="status" class="{{ $errors->has('status') ? 'is-invalid' : '' }}" style="appearance:none;padding-right:2.5rem;cursor:pointer;" required>
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="divide-y divide-gray-50 px-5">
                        <div class="py-3 flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-xs text-gray-400 font-medium">Route</p>
                                <p class="text-sm font-semibold text-gray-900">{{ $trip->start_location }} → {{ $trip->end_location }}</p>
                            </div>
                        </div>
                        <div class="py-3 flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-xs text-gray-400 font-medium">Vehicle</p>
                                <p class="font-mono text-sm font-bold text-blue-700">{{ $trip->vehicle->plate_number ?? 'N/A' }}</p>
                            </div>
                        </div>
                        <div class="py-3 flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-xs text-gray-400 font-medium">Driver</p>
                        ...
                        <div class="py-3 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                @elseif($trip->status === 'in_progress')
                                    <span class="inline-flex items-center gap-1.5 px-2 py-0.5 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full border border-blue-200">
                        ...
                        <div class="py-3 flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-xs text-gray-400 font-medium">Distance</p>
                                <p class="text-sm font-semibold text-gray-900">{{ number_format($trip->distance, 1) }} km</p>
                            </div>
                        </div>
                        @endif
                    </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="px-5 py-4">
                        <ul class="space-y-3">
                            @foreach([
                                'Update status as the trip progresses to keep records accurate.',
                                'Set end time only when the trip has actually finished.',
                                'Distance updates improve analytics and fuel tracking quality.',
                            ] as $tip)
